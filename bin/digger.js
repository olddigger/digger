...
program
  .command('build')
  .description('produce the digger.json file for the stack')
  .action(function(){

    tools.dobuild(function(){
...
program
  .command('compile')
  .description('process the stack into quarry runtime')
  .action(function(){

    console.log('');
    console.log('   digger compile v' + version);
